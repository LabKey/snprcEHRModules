...
BEGIN
    ...
    BEGIN TRY
        ...
        (SELECT pv1.MessageID,                          -- MESSAGE_ID - varchar(50)
         ...
         FROM Orchard_hl7_staging.dbo.ORC_Segment_PV1_A AS pv1
             INNER JOIN Orchard_hl7_staging.dbo.ORC_Segment_PV1_B AS pv1b
    ...
    BEGIN
        BEGIN TRY
            ...
            FROM labkey.snprc_ehr.HL7_OBX AS cpx
                INNER JOIN labkey.snprc_ehr.HL7_OBR AS cpr
        ...
        BEGIN CATCH
            SELECT @error = -101;
            SELECT @errormsg
                = 'Error deleting message: *' + @MessageId + '* from HL7_OBX.' + CHAR(13) + CHAR(10) + ERROR_MESSAGE();
            GOTO error;
        END CATCH;
        ...
        BEGIN TRY
            ...
            FROM labkey.snprc_ehr.HL7_NTE AS cpn
                JOIN labkey.snprc_ehr.HL7_OBR AS cpr
        ...
        BEGIN CATCH
            SELECT @error = -101;
            SELECT @errormsg
                = 'Error deleting message: *' + @MessageId + '* from HL7_NTE.' + CHAR(13) + CHAR(10) + ERROR_MESSAGE();
            GOTO error;
        END CATCH;
        ...
        BEGIN CATCH
            SELECT @error = -101;
            SELECT @errormsg
                = 'Error updating message: *' + @MessageId + '* from HL7_OBR.' + CHAR(13) + CHAR(10) + ERROR_MESSAGE();
            GOTO error;
        END CATCH;
        ...
        VALUES
        (@MessageId, @hl7_observation_date_tm, @hl7_message_control_id, 1, @hl7_result_status, @animal_id,
    ...
    IF @hl7_result_status = 'F'
       OR @hl7_result_status = 'C'
       OR @hl7_result_status = 'D'
    BEGIN
        -- RESULT_STATUS = 'F'
        ...
        BEGIN CATCH
            SELECT @error = -101;
            SELECT @errormsg
                = 'Error inserting message: *' + @MessageId + '* into HL7_OBR.' + CHAR(13) + CHAR(10) + ERROR_MESSAGE();
            GOTO error;
        END CATCH;
        ...
        BEGIN CATCH
            SELECT @error = -101;
            SELECT @errormsg
                = 'Error inserting message: *' + @MessageId + '* into HL7_OBX.' + CHAR(13) + CHAR(10) + ERROR_MESSAGE();
            GOTO error;
        END CATCH;
        ...
        BEGIN TRY
            ...
            FROM labkey.snprc_ehr.HL7_OBX AS cpx
                INNER JOIN cte
                    ON cpx.MESSAGE_ID = cte.MessageID
                       AND cpx.IDX > cte.OBR_IDX
                       AND cpx.IDX < cte.next_OBR_IDX
                INNER JOIN Orchard_hl7_staging.dbo.ORC_Segment_OBX_A AS OBX
                    ON cpx.MESSAGE_ID = OBX.MessageID
                       AND cpx.IDX = OBX.IDX
