...
/*==============================================================*/
/* View: v_BiocontainmentObservations                                     */
/*==============================================================*/
-- Source table: dbo.BiocontainmentObservation, as defined in AsiObsServices/src/Database/Animal.dbml.

CREATE VIEW [labkey_etl].[v_BiocontainmentObservations] as
-- ==========================================================================================
-- Author:     Ram
-- Create date: 09/10/26
-- Description: Selects Biocontainment Observations records from CAMP's dbo.BiocontainmentObservation
--              for the CAMP to TAC import ETL (resources/etls/BiocontainmentObservations.xml)
-- ==========================================================================================
SELECT o.Id as Id,
...
grant SELECT on labkey_etl.V_BIOCONTAINMENTOBSERVATIONS to z_labkey
