 ...
 */
Ext4.define('SNPRC_EHR.window.CopyTissuesWindow', {
    ...
    onSubmit: function(){
        ...
        LABKEY.Query.selectRows({
            ...
            columns: 'Id,tissue,tissue/meaning,project,project/displayName,project/investigator,recipient,recipient/lastname,dateOnly,parentid,sampletype,remark,requestcategory',
...
EHR.DataEntryUtils.registerGridButton('COPY_TISSUES', function(config){
    ...
    return Ext4.Object.merge({
        ...
        handler: function(btn){
            ...
            Ext4.create('SNPRC_EHR.window.CopyTissuesWindow', {
