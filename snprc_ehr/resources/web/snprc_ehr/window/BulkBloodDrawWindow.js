 ...
 * @cfg dataEntryPanel
 */
Ext4.define('SNPRC_EHR.window.BulkBloodDrawWindow', {
    ...
    initComponent: function(){
        Ext4.apply(this, {
            ...
            items: [{
                ...
                handler: function(){
                    window.location = LABKEY.contextPath + '/snprc_ehr/templates/Blood-Sedation Form.xlsx'
                }
            },{
                xtype: 'textarea',
                width: 770,
...
EHR.DataEntryUtils.registerDataEntryFormButton('BULK_BLOOD_DRAW', {
    ...
    handler: function(btn){
        ...
        Ext4.create('SNPRC_EHR.window.BulkBloodDrawWindow', {
