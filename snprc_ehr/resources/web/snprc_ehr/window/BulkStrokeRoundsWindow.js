 ...
 */
Ext4.define('SNPRC_EHR.window.BulkStrokeRoundsWindow', {
    ...
    initComponent: function(){
        Ext4.apply(this, {
            ...
            items: [{
                ...
                handler: function(){
                    window.location = LABKEY.contextPath + '/snprc_ehr/templates/MCA Occlusion Stroke Rounds.xlsx'
                }
            },{
                xtype: 'textarea',
                width: 770,
...
EHR.DataEntryUtils.registerDataEntryFormButton('STROKE_ROUNDS', {
    ...
    handler: function(btn){
        ...
        Ext4.create('SNPRC_EHR.window.BulkStrokeRoundsWindow', {
