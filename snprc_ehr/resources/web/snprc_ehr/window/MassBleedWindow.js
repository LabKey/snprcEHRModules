 ...
 * @cfg dataEntryPanel
 */
Ext4.define('SNPRC_EHR.window.MassBleedWindow', {
    ...
    initComponent: function(){
        Ext4.apply(this, {
            ...
            items: [{
                ...
                handler: function(){
                    window.location = LABKEY.contextPath + '/snprc_ehr/templates/DCM Mass Processing Form.xlsx'
                }
            },{
                xtype: 'labkey-combo',
                allowBlank: false,
...
EHR.DataEntryUtils.registerDataEntryFormButton('MASS_BLEED', {
    ...
    handler: function(btn){
        ...
        Ext4.create('SNPRC_EHR.window.MassBleedWindow', {
