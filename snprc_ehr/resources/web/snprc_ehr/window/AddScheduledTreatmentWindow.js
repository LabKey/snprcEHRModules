...
* Features
    ...
    * that match their criteria.  It is connected to the 'Add Treatments' button in the treatments form at SNPRC.
    * Originally Named EHR.window.AddScheduledTreatmentsWindow'
 */
Ext4.define('SNPRC_EHR.window.AddScheduledTreatmentWindow', {
...
EHR.DataEntryUtils.registerGridButton('ADDTREATMENTS', function(config){
    return Ext4.Object.merge({
        ...
        handler: function(btn){
            ...
            Ext4.create('snprc_ehr.window.AddScheduledTreatmentWindow', {
