 ...
 */
Ext4.define('SNPRC_EHR.window.BulkSerologyScanWindow', {
    ...
    initComponent: function(){
        Ext4.apply(this, {
            ...
            items: [{
                ...
                handler: function(){
                    window.location = LABKEY.contextPath + '/snprc_ehr/templates/Intuitive_Template.xlsx'
                }
            },{
                xtype: 'textarea',
                width: 770,
...
EHR.DataEntryUtils.registerDataEntryFormButton('SEROLOGY_SCAN_IMPORT', {
    ...
    handler: function(btn){
        ...
        Ext4.create('SNPRC_EHR.window.BulkSerologyScanWindow', {
