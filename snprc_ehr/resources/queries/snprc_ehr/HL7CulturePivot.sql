...
GROUP BY obr.ANIMAL_ID, obr.OBSERVATION_DATE_TM, obr.MESSAGE_ID, obr.PROCEDURE_NAME, obr.SET_ID, obr.PROCEDURE_NAME, obr.PROCEDURE_ID, nte.COMMENT, obx.TEST_NAME --, obx.TEST_ID
    PIVOT RESULT, QUALITATIVE_RESULT, ABNORMAL_FLAGS BY TEST_NAME

--     TEST_ID IN
--     (
--     select TestId as TEST_ID from snprc_ehr.labwork_panels t
