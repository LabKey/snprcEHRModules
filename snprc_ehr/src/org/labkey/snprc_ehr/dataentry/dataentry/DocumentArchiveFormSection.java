...
public class DocumentArchiveFormSection extends AbstractFormSection
{
    ...
    {
        super("ArrivalInstructions", "Document Archive", "snprc-documentarchivepanel");

        addClientDependency(ClientDependency.fromPath("snprc_ehr/panel/DocumentArchivePanel.js"));
    }
