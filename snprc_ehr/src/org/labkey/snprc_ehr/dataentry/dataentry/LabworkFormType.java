...
public class LabworkFormType extends TaskForm
{
    ...
    public LabworkFormType(DataEntryFormContext ctx, Module owner)
    {
        ...
        addClientDependency(ClientDependency.fromPath("snprc_ehr/window/CopyFromRunsTemplateWindow.js"));
            //Added 2-5-2016 Blasa
        addClientDependency(ClientDependency.fromPath("snprc_ehr/model/sources/labworkTestPanel.js"));
        addClientDependency(ClientDependency.fromPath("snprc_ehr/model/sources/labworkPanel.js"));

        addClientDependency(ClientDependency.fromPath("snprc_ehr/buttons/labworkButtons.js"));

        //Added 3-25-2015 Blasa
        addClientDependency(ClientDependency.fromPath("snprc_ehr/window/BulkSerologyVirologyWindow.js"));
        //Added 4-6-2015 Blasa
        addClientDependency(ClientDependency.fromPath("snprc_ehr/window/BulkSerologyScanWindow.js"));
    }
