...
@Category({External.class, EHR.class, SNPRC.class})
public class SNPRC_EHRTest extends AbstractONPRC_EHRTest
{
    protected String PROJECT_NAME = "SNPRC_EHR_TestProject";
    ...
    {
        // No-op. Used to verify project setup and cleanup work correctly.
        log("Hooray!");
    }
    ...
    public void pathologyTest()
    {
        ...
        waitFor(new Checker()
        {
            ...
            public boolean check()
            {
                return Ext4FieldRef.getForLabel(SNPRC_EHRTest.this, "Case Number").getValue().toString().startsWith(caseNoBase);
            }
