...
public class SNDTestEventTriggerFactory implements EventTriggerFactory
{
    ...
    public EventTrigger createTrigger(String category)
    {
        ...
        {
            case "SNDTestTrigger" -> new SNDTestTrigger();
            case "ChlorideTestTrigger" -> new ChlorideTestTrigger();
            case "ChlorideBloodTestTrigger" -> new ChlorideBloodTestTrigger();
            case "ElectrolytesTestTrigger" -> new ElectrolytesTestTrigger();
            case "CalciumTestTrigger" -> new CalciumTestTrigger();
            default -> null;
        };
    }
}
